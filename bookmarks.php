...
global $TBDEV, $CURUSER, $lang;
   ...
   $htmlout.= ($variant == 'index' ? '<td class="colhead" align="center">Delete</td><td class="colhead" align="right">' : '') . 'DL</td><td class="colhead" align="right">Share</td>';
   ...
   $htmlout .= "<td class='colhead' align='center'><img src='".$TBDEV['pic_base_url']."upped.gif'  border='0' alt='Upped by' title='Upped by' /></td>\n";
    ...
    while ($row = mysql_fetch_assoc($res)) 
    {
      ...
      $htmlout.= ($variant == "index" ? "<td align='center'><a href='bookmark.php?torrent=".$id."&amp;action=delete'><img src='".$TBDEV['pic_base_url']."aff_cross.gif' border='0' alt='Delete Bookmark!' title='Delete Bookmark!' /></a></td>" : "");
...
/** Legand table for bookmark **/
    $htmlout .="<table width='320px' cellspacing='5' cellpadding='5' border='0' align='center'>
		<thead><tr>
		<td align='center' colspan='8' class='colhead3' title='Bookmark page icon legand'>Icon legend</td>
		</tr></thead>
        <tbody><tr>
...
/////////////////////// HTML OUTPUT //////////////////////////////
where ("Viewing Bookmarks",$CURUSER["id"]);
