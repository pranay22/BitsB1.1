...
'takesignup_welcome' => "Welcome to {$TBDEV['site_name']} ! :clap2: \n\n Feel to download torrents, and talk in the forums, please seed everything to at least 1.1 or 168 hour! We are very glad to have you here in our community, and we hope you have a good stay. Please feel free to contact any staff member in case you have any doubt(s). \nThanks for joining.\ncheers {$TBDEV['site_name']} staff.",
);

$lang['takesignup_email_body'] = <<<EOD

You have requested a new user account on <#SITENAME#> and you have
specified this address (<#USEREMAIL#>) as user email ID.

If you did not do this, please ignore this email. The person who entered your
email address had the IP address <#IP_ADDRESS#>. Please do not reply. This
kind of problem may happen to users with dynamic IP.
...
do this, your account will be deleted within a next 48 hours. We urge you to read
the RULES and FAQ before you start using Our site.
