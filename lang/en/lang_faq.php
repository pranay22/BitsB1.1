...
#FAQ
'faq_welcome' => "
    Our goal is not to become just another Torrent tracker. Our goal is to provide useful and latest Study materials.
    ...
    <br />
    Before you go any further you should read our <a class='altlink' href='useragreement.php'>user agreement</a>.
    <br />",
'faq_contents_header' => "Contents",
'faq_siteinfo_header' => "<ul><li><u>Site information</u>",
'faq_siteinfo_header2' => "Site Information",
'faq_siteinfo' => "<ul>
    ...
    <br />",
'faq_userinfo_header' => "<li><u>User information</u>",
'faq_userinfo_header2' => "User Information",
'faq_userinfo' => "<ul>
    ...
    <br />",
'faq_stats_header' => "<li><u>Stats</u>",
'faq_stats_header2' => "Stats",
'faq_stats' => "<ul>
    ...
    <br />",
'faq_uploading_header' => "<li><u>Uploading</u>",
'faq_uploading_header2' => "Uploading",
'faq_uploading' => "<ul>
    ...
    <br />",
'faq_downloading_header' => "<li><u>Downloading</u>",
'faq_downloading_header2' => "Downloading",
'faq_downloading' => "<ul>
    ...
    <br />",
'faq_improve_header' => "<li><u>How can I improve my download speed?</u>",
'faq_improve' => "<ul>
    ...
    <br />",
'faq_isp_header' => "<li><u>My ISP uses a transparent proxy. What should I do?</u>",
'faq_isp' => "<ul>
    ...
    <br />",
'faq_connect_header' => "<li><u>Why can't I connect? Is the site blocking me?</u>",
'faq_connect' => "<ul>  <li><a href='#conn1' class='altlink'>Name resolution problems</a></li>
    ...
    <br />",
'faq_problem' => "<li><u><b>What if I can't find the answer to my problem here?</b></u></ul>",
