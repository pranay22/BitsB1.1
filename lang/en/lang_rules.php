...
#RULES
'rules_general_header' => "General rules - <font color='#9AC4EB'>Breaking these rules can and will get you banned!</font>",
...
'rules_downloading_header' => "Downloading rules - <font color='#9AC4EB'>By not following these rules you will lose download privileges!</font>",
...
'rules_forum_header' => "General Forum Guidelines - <font color='#9AC4EB'>Please follow these guidelines or else you might end up with a warning!</font>",
'rules_forum_body' => "<ul>
...
'rules_avatar_header' => "Avatar Guidelines - <font color='#9AC4EB'>Please try to follow these guidelines</font>",
...
'rules_uploading_header' => "Uploading rules - <font color='#9AC4EB'>Torrents violating these rules may be deleted without notice</font>",
...
'rules_moderating_header' => "Moderating rules - <font color='#9AC4EB'>Whom to promote and why</font>",
'rules_moderating_body' => "<tr>
        <td class='embedded' bgcolor='#F5F4EA' valign='top' width='90'>&nbsp; <b>Power User</b></td>
      ...
      <tr>
        ...
        <td class='embedded' width='5'>&nbsp;</td>
        <td class='embedded'>This status is given ONLY by <a href='userdetails.php?id=1'><b>d6m4u</b></a> since he is the only one who can verify that they actually donated something.</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td class='embedded' width='5'>&nbsp;</td>
        <td class='embedded'>Appointed by Admins/SysOp. </td>
      </tr>
      <tr>
        <td class='embedded' bgcolor='#F5F4EA' valign='top'>&nbsp; <b><font color='#A83838'>Moderator</font></b></td>
        <td class='embedded' width='5'>&nbsp;</td>
        <td class='embedded'>Don't ask us. We will ask you.</td>
      </tr>",
'rules_mod_rules_header' => "Moderating Rules - <font color='#9AC4EB'>Use your better judgement!</font>",
'rules_mod_rules_body' => "<ul>
      ...
      <br />",
'rules_mod_options_header' => "Moderating options - <font color='#9AC4EB'>What are my privileges as a mod?</font>",
