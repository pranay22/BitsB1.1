...
function usertable($res, $frame_caption)
  {
    ...
    $htmlout .= "<tr>
    <td class='colhead3'>{$lang['common_rank']}</td>
    <td class='colhead3' align='left'>{$lang['user']}</td>
    <td class='colhead3'>{$lang['user_ul']}</td>
    <td class='colhead3' align='left'>{$lang['user_ulspeed']}</td>
    <td class='colhead3'>{$lang['user_dl']}</td>
    <td class='colhead3' align='left'>{$lang['user_dlspeed']}</td>
    <td class='colhead3' align='right'>{$lang['common_ratio']}</td>
    <td class='colhead3' align='left'>{$lang['user_joined']}</td>
        ...
        {
          ++$num;
          $highlight = $CURUSER["id"] == $a["userid"] ? " bgcolor='#85b0b6'" : "";
          if ($a["downloaded"])
          {
          ...
          $htmlout .= "<tr$highlight><td align='center'>$num</td><td align='left'$highlight><a href='userdetails.php?id=" .
              ...
              "</td><td align='left'>" . get_date( $a['added'],'') . "</td></tr>";
        }
        $htmlout .= end_table();
        $htmlout .= end_frame();
...
function _torrenttable($res, $frame_caption)
    {
      ...
      $htmlout .= "<tr>
      <td class='colhead3' align='center'>{$lang['common_rank']}</td>
      <td class='colhead3' align='left'>{$lang['torrent_name']}</td>
      <td class='colhead3' align='right'>{$lang['torrent_snatch']}</td>
      <td class='colhead3' align='right'>{$lang['torrent_data']}</td>
      <td class='colhead3' align='right'>{$lang['torrent_seed']}</td>
      <td class='colhead3' align='right'>{$lang['torrent_leech']}</td>
      <td class='colhead3' align='right'>{$lang['torrent_total']}</td>
      <td class='colhead3' align='right'>{$lang['common_ratio']}</td>
      </tr>";
  ...
  function countriestable($res, $frame_caption, $what)
  {
    ...
    $htmlout .= begin_table();
      ...
      $htmlout .= "<tr>
      <td class='colhead3'>{$lang['common_rank']}</td>
      <td class='colhead3' align='left'>{$lang['country']}</td>
      <td class='colhead3' align='right'>{$lang['common_users']}</td>
      </tr>";
  ...
  function peerstable($res, $frame_caption)
  {
    ...
    $htmlout .= begin_table();
		...
		{
      $highlight = $CURUSER["id"] == $arr["userid"] ? " bgcolor='#85b0b6'" : "";
