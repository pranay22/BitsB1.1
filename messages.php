...
if (!$action)
{
    ...
    <tr><td align='left'><a href='messages.php?action=editmailboxes'><input type='submit'value='{$lang['messages_add_edit']}' class='btn' /></a></td><td align='right'>".insertJumpTo($mailbox)."</td></tr>
    </table>
